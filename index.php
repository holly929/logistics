...
<marquee>FELIX AGBENYEGA AGUADZE,INDEX NUMBER OK3375/19</marquee>
<body class="login-box">
	<h1>GES KSM LOGISTICS REQUETS MANAGEMENT SYSTEM </h1>
	...
	<li>
		...
		<option value="retailer">TRANSPORT OFF.</option>
		<option value="manufacturer">HEAD TEACHERD</option>
		<option value="admin">DIRECTOR/LOG.MANAGER/ADMIN</option>
		</select>
		</div>
	</li>
	<li>
